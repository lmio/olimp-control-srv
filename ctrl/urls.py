...
urlpatterns = [
    ...
    path("computer/<str:machine_id>/edit/", views.computer_edit, name="ctrl.computer_edit"),
    ...
    path("assignments/", views.assignment_list, name="ctrl.assignment_list"),
    path("assignments/new/", views.assignment_new, name="ctrl.assignment_new"),
    path(
        "assignments/<int:pk>/delete/",
        views.assignment_delete,
        name="ctrl.assignment_delete",
    ),
